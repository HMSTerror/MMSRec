...
def build_feature_variants() -> list[dict]:
    ...
    variants = [
        {
            "name": "text_category2x",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_category_w15_text_category2x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
        ...
        {
            "name": "text_brand2x",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_category_w15_text_brand2x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
        ...
        {
            "name": "text_brand2x_category2x",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_category_w15_text_brand2x_category2x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
...
def run_training_variants(variants: list[dict]) -> list[dict]:
    ...
    rows = []
    for spec in variants:
        experiment_name = f"beauty2013_metadata_v27_{spec['name']}_full_tuned"
...
def main() -> None:
    ...
    output_path = Path("outputs/paper/beauty2013/beauty2013_structured_text_repeat_v27_summary.json")
