...
def build_rescaled_feature_variants() -> list[dict]:
    ...
    variants = [
        {
            "name": "text_category2x_source070_fast",
            "output_path": ARTIFACTS_DIR / "content_features_metadata_fast_text_category2x_source070_w15.pt",
            "source_weight": 0.70,
        },
        {
            "name": "text_category2x_source072_fast",
            "output_path": ARTIFACTS_DIR / "content_features_metadata_fast_text_category2x_source072_w15.pt",
            "source_weight": 0.72,
        },
        {
            "name": "text_category2x_source078_fast",
            "output_path": ARTIFACTS_DIR / "content_features_metadata_fast_text_category2x_source078_w15.pt",
            "source_weight": 0.78,
        },
        {
            "name": "text_category2x_source080_fast",
            "output_path": ARTIFACTS_DIR / "content_features_metadata_fast_text_category2x_source080_w15.pt",
            "source_weight": 0.80,
        },
    ]
    ...
    for spec in variants:
        ...
        rows.append(row)
        print(
            "=== BUILT FEATURES {name} dim={dim} source={source} ===".format(
                name=row["name"],
...
def run_training_variants(feature_rows: list[dict]) -> list[dict]:
    ...
    for feature in feature_rows:
        experiment_name = f"beauty2013_metadata_v32_{feature['name']}_full_tuned"
...
def main() -> None:
    ...
    output_path = Path("outputs/paper/beauty2013/beauty2013_category_source_keepw15_v32_summary.json")
