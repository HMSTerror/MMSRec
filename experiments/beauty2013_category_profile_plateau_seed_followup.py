...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run plateau-scheduler seed follow-up for the strongest category-profile family."
    )
    parser.add_argument("--feature-path", default=str(FEATURE_PATH))
    parser.add_argument("--experiment-tag", default="v47_profile_plateau_seed")
