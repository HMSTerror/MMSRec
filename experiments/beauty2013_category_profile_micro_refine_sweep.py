...
def main() -> None:
    gate_inits = [-2.52, -2.51, -2.49, -2.48, -2.47]
    rows = []
    for gate_init in gate_inits:
        gate_slug = str(gate_init).replace("-", "m").replace(".", "p")
        experiment_name = f"beauty2013_metadata_v41_source075_w15_catprofile_micro_{gate_slug}"
    ...
    output_path = Path("outputs/paper/beauty2013/beauty2013_category_profile_micro_refine_v41_summary.json")
