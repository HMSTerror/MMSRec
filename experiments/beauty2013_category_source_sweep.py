...
def build_feature_variants() -> list[dict]:
    ...
    variants = [
        {
            "name": "text_category2x_source072_cw125",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source072_brand_w15_category125_text_category2x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                ...
                "brand_svd_dim": 32,
                "category_svd_dim": 64,
                "source_text_weight": 0.72,
                "brand_weight": 1.5,
                "category_weight": 1.25,
            },
        },
        {
            "name": "text_category2x_source078_cw125",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source078_brand_w15_category125_text_category2x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
                ...
                "brand_svd_dim": 32,
                "category_svd_dim": 64,
                "source_text_weight": 0.78,
                "brand_weight": 1.5,
                "category_weight": 1.25,
            },
        },
        {
            "name": "text_category2x_source080_cw125",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source080_brand_w15_category125_text_category2x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
...
def run_training_variants(variants: list[dict]) -> list[dict]:
    ...
    rows = []
    for spec in variants:
        experiment_name = f"beauty2013_metadata_v30_{spec['name']}_full_tuned"
...
def main() -> None:
    ...
    output_path = Path("outputs/paper/beauty2013/beauty2013_category_source_v30_summary.json")
