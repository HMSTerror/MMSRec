...
def main() -> None:
    variants = [
        {
            "name": "profilem2p5_memoryw1p0",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_source075_w15_with_category_memory_w1p0.pt",
            "category_profile_gate_init": -2.5,
        },
        {
            "name": "profilem2p5_memoryw1p5",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_source075_w15_with_category_memory_w1p5.pt",
            "category_profile_gate_init": -2.5,
        },
        {
            "name": "profilem2p5_memoryw2p0",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_source075_w15_with_category_memory_w2p0.pt",
            "category_profile_gate_init": -2.5,
        },
    ]
    ...
    for spec in variants:
        experiment_name = f"beauty2013_metadata_v42_source075_w15_{spec['name']}"
        ...
        config = MMTrainConfig(
            ...
            category_profile_gate_init=spec["category_profile_gate_init"],
        )
    ...
    output_path = Path("outputs/paper/beauty2013/beauty2013_category_profile_memory_combo_v42_summary.json")
