...
def build_feature_variants() -> list[dict]:
    ...
    variants = [
        {
            "name": "title32_tw10",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_category_w15_title32_tw10.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
        ...
        {
            "name": "title32_tw15",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_category_w15_title32_tw15.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
        ...
        {
            "name": "title64_tw10",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_category_w15_title64_tw10.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
        ...
        {
            "name": "title64_tw15",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_category_w15_title64_tw15.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
...
def run_training_variants(variants: list[dict]) -> list[dict]:
    ...
    rows = []
    for spec in variants:
        experiment_name = f"beauty2013_metadata_v25_{spec['name']}_full_tuned"
...
def main() -> None:
    ...
    output_path = Path("outputs/paper/beauty2013/beauty2013_title_v25_summary.json")
