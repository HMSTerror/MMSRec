...
def main() -> None:
    gate_inits = [-2.45, -2.40, -2.35, -2.30]
    rows = []
    for gate_init in gate_inits:
        gate_slug = str(gate_init).replace("-", "m").replace(".", "p")
        experiment_name = f"beauty2013_metadata_v38_source075_w15_catprofile_refine_{gate_slug}"
    ...
    output_path = Path("outputs/paper/beauty2013/beauty2013_category_profile_refine_v38_summary.json")
