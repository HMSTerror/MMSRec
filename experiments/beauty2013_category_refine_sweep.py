...
def build_feature_variants() -> list[dict]:
    ...
    variants = [
        {
            "name": "text_category2x_cw125",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_w15_category125_text_category2x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
        ...
        {
            "name": "text_category2x_cw100",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_w15_category100_text_category2x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
        ...
        {
            "name": "text_category3x_cw125",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source075_brand_w15_category125_text_category3x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
                ...
                "append_brand_embeddings": True,
                "append_category_embeddings": True,
                "extra_category_repeats_in_text": 2,
                "brand_svd_dim": 32,
                "category_svd_dim": 64,
                "source_text_weight": 0.75,
                "brand_weight": 1.5,
        ...
        {
            "name": "text_category2x_source070_cw125",
            "feature_path": ARTIFACTS_DIR / "content_features_metadata_tfidf_df1_plus_source070_brand_w15_category125_text_category2x.pt",
            "feature_kwargs": {
                "text_svd_dim": 512,
                "min_df": 1,
                "max_text_features": 50000,
...
def run_training_variants(variants: list[dict]) -> list[dict]:
    ...
    rows = []
    for spec in variants:
        experiment_name = f"beauty2013_metadata_v29_{spec['name']}_full_tuned"
...
def main() -> None:
    ...
    output_path = Path("outputs/paper/beauty2013/beauty2013_category_refine_v29_summary.json")
