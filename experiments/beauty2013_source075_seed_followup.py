...
FEATURE_PATH = ROOT_DIR / "artifacts" / "content_features_metadata_tfidf_df1_plus_source075_brand_category_w15.pt"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run matched-seed follow-up for the source075_w15 family under the current code."
    )
    parser.add_argument("--feature-path", default=str(FEATURE_PATH))
    parser.add_argument("--experiment-tag", default="v49_source075_w15_currentcode")
    parser.add_argument("--seeds", default="103,104")
